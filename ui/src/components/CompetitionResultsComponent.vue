...
const columns: QTableColumn<CompetitionResult>[] = [
  ...
  { name: 'squat1Kg', label: 'Squat', field: 'squat1Kg', align: 'left' },
  ...
  { name: 'bench1Kg', label: 'Bench', field: 'bench1Kg', align: 'left' },
  ...
  { name: 'deadlift1Kg', label: 'Deadlift', field: 'deadlift1Kg', align: 'left' },
